...
- 필요한 이미지 소스가 devtool에 존재하지 않았기에 수작업이 필요하고 사용할 수 없었던 점
- 모바일(반응형) 디자인이 어려웠던 점 <-- 감이 안잡힘
- 헤더 서브메뉴(드랍박스)가 계속 오류나는 문제

#### 마지막 멘트
- 좀 더 프론트엔드에 대해 공부하고 싶은 마음이 듭니다. 많이 부족하다는 생각이 듭니다. 특히나 모바일(반응형) 부분이 어려웠기에 더욱 공부해야겠다는 생각을 했습니다.
